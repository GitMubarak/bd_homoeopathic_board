...
insert  into `form_fillup`(`form_fillup_id`,`registration_no`,`last_university`,`dhms_exam_name_session`,`dhms_exam_center`,`dhms_exam_roll`,`dhms_exam_year`,`disqualified_exam_name`,`disqualified_exam_center`,`disqualified_exam_roll`,`disqualified_exam_year`,`disqualified_punishment`,`language`,`academic_language`,`subject_code_1`,`subject_code_2`,`subject_code_3`,`subject_code_4`,`subject_code_5`,`subject_code_6`,`status`,`create_date`,`modify_date`) values (1,126511,'IIUC','test exam1','Test center2',12345,2001,'test exam2','center2',54321,2002,'ha ha ha','bangla','english',101,101,101,101,101,101,1,'2018-04-18 18:38:03','2018-04-18 18:38:03');
